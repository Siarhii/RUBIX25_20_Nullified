                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-400">
                            Preserving memories and delivering messages to the future. Create your digital legacy today.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/help" className="text-sm hover:text-white transition-colors">Help Center</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-center gap-2 text-sm">
                                ...
                                <a href="mailto:support@vaulture.com" className="hover:text-white transition-colors">
                                    support@vaulture.com
                                </a>
                            </li>
                            <li className="flex items-center gap-2 text-sm">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="border-t border-gray-800">
                <div className="max-w-[90%] mx-auto px-4 py-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                        <p className="text-sm text-gray-400">
                            © 2024 Vaulture. All rights reserved.
                        </p>
